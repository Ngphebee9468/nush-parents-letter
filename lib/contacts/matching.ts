...
const teacherAliasFallback: Record<string, Array<{ name: string; tel: string; email: string }>> = {
  ...
  JTYH: [{ name: "Mr Teoh Yeow Hwee Joel", tel: "6601 3237", email: "nhstyhj@nus.edu.sg" }],
  ...
  WJ: [{ name: "Mr Wu Jiong", tel: "6516 8636", email: "nhswj@nus.edu.sg" }],
  LZ: [{ name: "Dr Li Liangzi", tel: "6516 1732", email: "nhslilz@nus.edu.sg" }],
  LLZ: [{ name: "Dr Li Liangzi", tel: "6516 1732", email: "nhslilz@nus.edu.sg" }],
  HKK: [{ name: "Mr Ho Kok Kiat", tel: "6516 1734", email: "nhshokk@nus.edu.sg" }],
  TSF: [{ name: "Ms Thian Siaw Fong", tel: "6516 3648", email: "anshthian@nus.edu.sg" }],
  LPSMT: [{ name: "Ms Lim Puay See", tel: "6601 7297", email: "nhslps@nus.edu.sg" }],
  ...
  AS: [{ name: "Mdm Asrina Binte Sani", tel: "6516 7719", email: "nhsasri@nus.edu.sg" }],
  IP: [{ name: "Ms Poh Irene", tel: "6601 8086", email: "anhsipoh@nus.edu.sg" }],
  CSKS: [{ name: "Mr Soh Kwan Seng Clifton", tel: "6516 7293", email: "nhssksc@nus.edu.sg" }],
  LYH: [{ name: "Mr Lim Yeow Heng", tel: "6516 5216", email: "nhslyh@nus.edu.sg" }],
  ZJ: [{ name: "Ms Zhong Jingyi", tel: "6601 2721", email: "nhszj@nus.edu.sg" }],
  ZK: [{ name: "Ms Zhong Jingyi", tel: "6601 2721", email: "nhszj@nus.edu.sg" }],
  LKH: [{ name: "Mr Lee Kim Hun", tel: "6516 8213", email: "nhslkh@nus.edu.sg" }],
  LLC: [{ name: "Ms Lim Li Chen", tel: "6516 1736", email: "nhsllc@nus.edu.sg" }],
  DYSY: [{ name: "Mr Yeo Shyh Yuan Don", tel: "6516 1721", email: "nhsysy@nus.edu.sg" }],
  LKL: [{ name: "Dr Low Kai Leng", tel: "6516 1743", email: "nhslowkl@nus.edu.sg" }],
  EV: [{ name: "Ms Lau Wen Li Sofia", tel: "6516 8535", email: "nhslwls@nus.edu.sg" }],
  LCH: [{ name: "Mr Low Chin Han", tel: "6516 7300", email: "nhslch@nus.edu.sg" }],
  NOH: [{ name: "Ms Ng Oon Hui Phebee", tel: "6516 1722", email: "nhsnoh@nus.edu.sg" }],
  NOOH: [{ name: "Ms Ng Oon Hui Phebee", tel: "6516 1722", email: "nhsnoh@nus.edu.sg" }],
  FKC: [{ name: "Mdm Fong Kit Ching", tel: "6516 8531", email: "nhsfkc@nus.edu.sg" }],
  RSK: [{ name: "Dr Seoh Kah Huat Robin", tel: "6601 1315", email: "nhsskh@nus.edu.sg" }],
  RSKH: [{ name: "Dr Seoh Kah Huat Robin", tel: "6601 1315", email: "nhsskh@nus.edu.sg" }],
  RYIC: [{ name: "Mrs Yeo-Lim Ing Chieh Rebekah", tel: "6516 8536", email: "nhslic@nus.edu.sg" }],
  CB: [{ name: "Ms Chua Bann", tel: "6516 1775", email: "nhscb@nus.edu.sg" }],
  PHPS: [{ name: "Ms Huang Pei Shan Pearl Mia", tel: "6516 2434", email: "anhs_hps@nus.edu.sg" }],
  DWSP: [{ name: "Mr Wong Sung Peng Daniel", tel: "6601 1802", email: "dwong_15@nus.edu.sg" }],
  RCMH: [{ name: "Mr Chai Ming Huang Royce", tel: "6516 2032", email: "nhscmh@nus.edu.sg" }],
  JYHM: [{ name: "Mr Yeo Heu Ming Jeremy", tel: "6601 1785", email: "anhs.yhm@nus.edu.sg" }],
  LD: [{ name: "Mr Li Da", tel: "6516 6596", email: "nhsld@nus.edu.sg" }],
  CCES: [{ name: "Mr Chua Eng Siong Claude", tel: "6516 5247", email: "nhscesc@nus.edu.sg" }],
  LW: [{ name: "Dr Li Wei", tel: "6516 8627", email: "nhslw@nus.edu.sg" }],
  YW: [{ name: "Ms Yenny Wijaya", tel: "6516 5804", email: "nhsyw@nus.edu.sg" }],
  JJPM: [{ name: "Dr Maury Julien Jean Pierre", tel: "6516 7063", email: "nhsmjjp@nus.edu.sg" }],
  PBH: [{ name: "Mr Poh Boon Hor", tel: "6516 7545", email: "nhspbh@nus.edu.sg" }],
  GTYM: [{ name: "Mrs Khoo-Teo Yew Mei Grace", tel: "6601 2096", email: "nhstymg@nus.edu.sg" }],
  THC: [{ name: "Dr Tang Hock Chun", tel: "6516 8639", email: "nhsthc@nus.edu.sg" }],
  ...
  PL: [{ name: "Phylliscia Lee", tel: "6516 7064", email: "nhscsp@nus.edu.sg" }],
  YXH: [{ name: "Mr Yuen Xiang Hao", tel: "6516 8534", email: "nhsyxh@nus.edu.sg" }],
  NYR: [{ name: "Mdm Ng Yu Rui", tel: "6601 2041", email: "nhsnyr@nus.edu.sg" }],
  NYP: [{ name: "Mdm Ng Yu Rui", tel: "6601 2041", email: "nhsnyr@nus.edu.sg" }],
  ...
  VLSF: [{ name: "Ms Lim Suat Fong Valerie", tel: "6516 7301", email: "nhslsf@nus.edu.sg" }],
  KF: [{ name: "Mrs Fernandez Kalpana", tel: "6516 5704", email: "nhskalpa@nus.edu.sg" }],
  ...
  YT: [{ name: "Ms Tang Yee Voon", tel: "6516 3593", email: "anhsyvtang@nus.edu.sg" }],
