...
insert into timetable_records (id, session_id, class_name, subject_raw, subject_display, teacher_initials_raw, teacher_initials_normalised, day, start_time, end_time, venue, source_text, extraction_confidence, extraction_confidence_source, included) values
  ('c1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', '602', 'ELC 6', 'English Language and Communication', 'LCS', 'LCS', 'Monday', '08:00', '09:00', 'E5-12', 'ELC 6 / LCS / E5-12', 0.97, 'pdf_text_extract', true),
  ('c1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', '602', 'Bio 6', 'Biology', 'NOH', 'NOH', 'Tuesday', '10:00', '11:00', 'E5-10', 'Bio 6 / NOH / E5-10', 0.97, 'pdf_text_extract', true),
  ('c1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000001', '602', 'Bio Hon 6', 'Biology Honours', 'THC', 'THC', 'Wednesday', '13:00', '14:00', 'E2-14', 'Bio Hon 6 / THC / E2-14', 0.95, 'pdf_text_extract', true),
  ('c1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000001', '602', 'Phys Hon 6', 'Physics Honours', 'BRW', 'BRW', 'Thursday', '08:00', '09:00', 'E5-12', 'Phys Hon 6 / BRW / E5-12', 0.96, 'pdf_text_extract', true),
  ('c1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000001', '602', 'EL 6', 'English Language', 'MT', 'MT', 'Friday', '10:00', '11:00', 'E5-10', 'EL 6 / MT / E5-10', 0.94, 'pdf_text_extract', true)
on conflict (id) do nothing;
